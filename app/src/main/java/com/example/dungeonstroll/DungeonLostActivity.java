...
public class DungeonLostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dungeon_lost);
        ...
        endInfo.setText(getResources().getIdentifier(dungeonName + "_lost", "string", getPackageName()));

        buttonFinish = findViewById(R.id.finishButton);
        buttonFinish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DungeonLostActivity.this, MenuActivity.class);
